def sql_select_students_parents(db_cursor, course_id: str, student_email: str):
    db_cursor.execute(
        """
        SELECT
            p.parentemail,
...
def sql_insert_parent_of_at_course(db_cursor, parent_email: str, student_email: str, course_id: str):
    db_cursor.execute(
...
def sql_delete_parent_of_at_course(db_cursor, course_id: str, student_email: str, parent_email: str):
    db_cursor.execute(
...
def sql_select_parents_children(db_cursor, course_id: str, parent_email: str):
    db_cursor.execute(
        """
        SELECT
            p.studentemail,

def sql_insert_material(db_cursor, course_id: str, title: str, description: str, user_email: str):
    db_cursor.execute(
...
def sql_delete_material(db_cursor, course_id: str, material_id: str):
    db_cursor.execute(
...
def sql_select_material(db_cursor, course_id: str, material_id: str):
    db_cursor.execute(
        """
...
def sql_insert_material_attachment(db_cursor, storage_db_cursor, course_id: str, material_id: str, filename: str, contents: bytes):
...
def sql_select_material_attachments(db_cursor, course_id: str, material_id: str):
    db_cursor.execute(
        """

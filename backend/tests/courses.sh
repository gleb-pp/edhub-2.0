...
fail_test "Request to create the material with too short title" \
    -X POST "$API_URL/create_material?course_id=$mathcourseid&section_id=1&title=Ti&description=Lecture%20material%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the material with too long title" \
    -X POST "$API_URL/create_material?course_id=$mathcourseid&section_id=1&title=TitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitle&description=Lecture%20material%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the material with invalid title" \
    -X POST "$API_URL/create_material?course_id=$mathcourseid&section_id=1&title=Ti%24tle&description=Lecture%20material%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the material with too short description" \
    -X POST "$API_URL/create_material?course_id=$mathcourseid&section_id=1&title=Title&description=De" \
    -H "Authorization: Bearer $TOKEN" \

# --------------------------------------------------------------------

fail_test "Request to create the assignment with too short title" \
    -X POST "$API_URL/create_assignment?course_id=$mathcourseid&section_id=1&title=Ti&description=Lecture%20assignment%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the assignment with too long title" \
    -X POST "$API_URL/create_assignment?course_id=$mathcourseid&section_id=1&title=TitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitleTitle&description=Lecture%20assignment%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the assignment with invalid title" \
    -X POST "$API_URL/create_assignment?course_id=$mathcourseid&section_id=1&title=Ti%24tle&description=Lecture%20assignment%20description" \
    -H "Authorization: Bearer $TOKEN" \

fail_test "Request to create the assignment with too short description" \
    -X POST "$API_URL/create_assignment?course_id=$mathcourseid&section_id=1&title=Title&description=De" \
    -H "Authorization: Bearer $TOKEN" \
...
expected='[
    {"course_id":"'"$mathcourseid"'","post_id":'$materialid',"section_id":1,"section_name":"General","section_order":0,"type":"mat","author":"alice@example.com"},
...
expected='
    {"course_id":"'"$mathcourseid"'","material_id":'$materialid',"section_id":1,"title":"Lecture material","description":"Lecture material description","author":"alice@example.com"}
'
...
materialid=$(curl -s -X POST \
    -H "Authorization: Bearer $TOKEN" \
    "$API_URL/create_material?course_id=$engcourseid&section_id=2&title=Lecture%20material&description=Lecture%20material%20description" | extract_field material_id)

# --------------------------------------------------------------------

assignmentid=$(curl -s -X POST \
    -H "Authorization: Bearer $TOKEN" \
    "$API_URL/create_assignment?course_id=$engcourseid&section_id=2&title=Assignment%201&description=To%20do%20exercise%2010%20from%20the%20course%20book" | extract_field assignment_id)
...
expected='[
    {"course_id":"'"$engcourseid"'","post_id":'$materialid',"section_id":2,"section_name":"General","section_order":0,"type":"mat","author":"bob@example.com"},
    {"course_id":"'"$engcourseid"'","post_id":'$assignmentid',"section_id":2,"section_name":"General","section_order":0,"type":"ass","author":"bob@example.com"}
]'
...
expected='
    {"course_id":"'"$engcourseid"'","material_id":'$materialid',"section_id":2,"title":"Lecture material","description":"Lecture material description","author":"bob@example.com"}
'
...
expected='
    {"course_id":"'"$engcourseid"'","assignment_id":'$assignmentid',"section_id":2,"title":"Assignment 1","description":"To do exercise 10 from the course book","author":"bob@example.com"}
'
...
expected='[
    {"course_id":"'"$engcourseid"'","post_id":null,"section_id":2,"section_name":"General","section_order":0,"type":null,"author":null}
]'
